...
import 'package:pinolo/src/ui/report_user_auctioneer.dart';
...
class ParkingCompletedAuctioneer extends StatefulWidget {
  const ParkingCompletedAuctioneer({Key? key}) : super(key: key);

  @override
  State<ParkingCompletedAuctioneer> createState() => _ParkingCompletedAuctioneerState();
}

class _ParkingCompletedAuctioneerState extends State<ParkingCompletedAuctioneer> {
  @override
          ...
          children: [
            ...
            AppCommon.appButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) =>  ReportUserAuctioneer()),
                  );
                },
